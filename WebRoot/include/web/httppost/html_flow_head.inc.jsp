...
<% String loginName= (String) session.getAttribute("pname");%>
<body>
	<div class="navbar">
			...
			<div class="container-fluid">
				...
				<div class="btn-group pull-right login-user"
					...
					<div class="btn-group" style="width:40px;">
						<span style="margin-left: -22px;"> <strong><%=loginName %></strong>
						</span>
						<image class="dropdown-toggle" data-toggle="dropdown"
							src="<%=head_path%>/image/pull_down.png" />
						<ul class="dropdown-menu" role="menu">
							<li><a
								href="<%=head_path%>/action/httppost/userCenter/admin/selfInfo/ChangePassGet.action">修改密码</a>
							</li>
							<li><a
								href="<%=head_path%>/action/httppost/userCenter/admin/LogoutGet.action">注销</a>
							</li>
						</ul>
					</div>
				...
				<a
					href="<%=head_path%>/action/httppost/userCenter/admin/IndexGet.action"
