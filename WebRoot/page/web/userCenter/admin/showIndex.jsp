			...
			<div class="box-content">
				<form id="form1" method="post" class="form-horizontal">
                  ...
                  &nbsp;&nbsp;<label style="margin-top:6px;">${map.pcode }</label>
						...
						<div class="control-group" style="margin-left:-30px;">
						<label class="control-label" for="">项目地址：</label>
                  &nbsp;&nbsp;<label style="margin-top:6px;">${map.address }</label>
					</div>
						<div class="control-group" style="margin-left:-30px;">
						<label class="control-label" for="">负责任名称：</label>
                  &nbsp;&nbsp;<label style="margin-top:6px;">${map.person }</label>
					</div>
						<div class="control-group" style="margin-left:-30px;">
						<label class="control-label" for="">电话：</label>
                  &nbsp;&nbsp;<label style="margin-top:6px;">${map.phone_num }</label>
					</div>
					<div class="control-group" style="margin-left:-30px;">
