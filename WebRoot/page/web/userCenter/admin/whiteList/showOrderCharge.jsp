	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header wells well-list">
				<h2>
					<i class="icon-edit"></i>车辆充值(只用于储值车)
				</h2>
			</div>
				...
				<div class="box-content">
					...
					<%if(list!=null && list.size()>0)
					 ...
					 <%}%> 
						...
						<div class="control-group">
							<label class="control-label" for="startTime">新车辆余额：</label> <input
								type="text" class="input-xlarge" id="CardAmount"
								name="CardAmount"/> <span
								id="CardAmountTip" class="required_dis"></span>
						</div>
								<div class="control-group">
...
$.ajax({
	type : "POST",
	url : "OrderChargePost.action?M=" + Math.random(),
	data : "cardCode=" + $("#cardCode").val().toString() + "&CardAmount="
			+ $("#CardAmount").val().toString()+ "&PayAmount="
