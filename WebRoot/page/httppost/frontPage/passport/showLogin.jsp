...
%>
<%@ include file="/include/web/httppost/html_head.inc.jsp"%>
...
<div class="login-bg">
	<div class="login-logo-new" style="    background: url(../image/bg_tm.png);">
		...
		<div class="login-bg">
			<div class="login-box-new">
				...
				<div class="title" id="pc_title">停车场后台管理</div>
				<div class="title" style="display: none;" id="code_title"></div>
				<div class="form">
   ...
   <div class="login-foot" style="height:50px;width:400px;position:fixed;right:20px;bottom:20px;">
  Copyright ©2016-2020 太格王科技 Software, All Rights Reserved </div>
		...
		$.ajax({
			...
			success : function(data) {
            	...
            	if (loginResult == "loginOK") {
            		...
            		location.href = "<%=path%>/action/httppost/userCenter/admin/IndexGet.action";
