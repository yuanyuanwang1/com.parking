	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header wells well-list">
				<h2>
					<i class="icon-edit"></i> ${commonUser.pname}添加其他车场
				</h2>
			</div>
			<div class="box-content">
				<div class="box-content">
					...
					<input type="hidden" value="${pid }" name="createUserId"/>
				  ...
				  <div class="control-group" style="padding-left:70px;">
						...
						&nbsp;&nbsp;&nbsp;&nbsp; <a class="btn btn-primary"
							href="OtherListGet.action?pid=${pid }">返回</a>
							</div>
					</form>
				</div>
			</div>
...
$.ajax({
	type : "POST",
	url : "OtherAddPost.action?M=" + Math.random(),
