...
<body id="body" style="background: white;">
	...
	<div class="fullscreen per_login" style="margin-top: 12px;">
		...
		<span style="color:#289ED7;font-size: 20px">新增账户</span>
			...
			<form id="form1" name="form1" method="post" >
				<div class="join">
					...
					<div>
						...
						<input id="pcode" name="pcode" placeholder="请输入账号名称"
					...
					<div>
						...
						<input id="pname" name="pname" placeholder="请输入使用者姓名"
							type="text" value="" class="timeSel" style="vertical-align: top;" />
					</div>

					<label>描述</label>
					<div>
						<input type="textarea" style="height:80px;" placeholder="请输入使用者描述"
							name="descriptions" id="descriptions" />
					</div>
					<br />
					<button type="button" id="addBtn">新 增</button>
					<br /><br />
...
$.ajax({
	type : "POST",
	url : "ParkAddPost.action?M=" + Math.random(),
