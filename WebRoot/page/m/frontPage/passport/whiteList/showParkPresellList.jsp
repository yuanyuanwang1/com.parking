...
<%
    ...
    String pageURI = "ParkPresellListGet.action";
	List<Map<String, Object>> dataList = (List<Map<String, Object>>) request.getAttribute("list");
...
<body id="body" style="background: white;">
	...
	<div class="fullscreen per_login" style="margin-top: 12px;">
		...
		<span style="color:#289ED7;"> <strong>下发预约信息明细</strong>
		</span>
		...
		<section class="inner_content" style="padding-top: 10px;">
         <form method="get" action="<%=pageURI%>" class="form-horizontal">
				...
				<tr style="color:#289ED7;">
					<td>车牌号</td>
					<td style="padding-left: 21px;">车牌类型</td>
					<td style="padding-left: 21px;">车辆类型</td>
					<td style="padding-left: 24px;">截止有效期</td>
				    <td style="padding-left: 21px;">下发操作员</td>
				</tr>
				<tr>
				...
				<tr style="height: 15px;" >
					<td style="color:black;width: 43px"><%=map.get("CarNo")%></td>
					<td style="color:black;padding-left: 15px;width: 43px"><%=map.get("CardType")%></td>
					<td style="color:black;padding-left: 30px;width: 50px"><%=map.get("CarType")%></td>
					<td style="color:black;padding-left: 28px;"><%=map.get("CardIndate")%></td>
			...
			<button type="button" id="login_btn" onclick="javascript:window.location.href='ParkPresellListSelGet.action'">返回</button>
</form>
		</section>
