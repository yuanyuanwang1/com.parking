	...
	<div class="fullscreen per_login" style="margin-top: 12px;">
		...
		<section class="inner_content" style="padding-top: 10px;">
			...
			<form id="loginform" name="loginform" method="post"
				action="ParkPresellListGet.action">
				<table>
					<tr>
					...
					<tr>
						...
						<td><select class="jqSel" name="parkCode" id="parkCode"
							style="vertical-align: top;">
								...
								%>
								<option value="<%=map.get("parkCode")%>"><%=map.get("parkCode")%>车场
								</option>
								<%
									}
									}
					...
					<tr>
						<td><img src="<%=path%>/image/search.png"
							style="width:45%;height:45%;"></td>
						<td><input id="searchValue" name="searchValue" type="text" value=""
							class="timeSel" style="vertical-align: top;" placeholder=""/>
							</div>
						</td>
					</tr>
				</table>
				...
				<button type="button" id="login_btn" onclick="history.go(-1)">返回</button>
			</form>
