...
public class AlipaySubmit {
	...
	public static String buildRequestMysign(Map<String, String> sPara,
		...
		if (AlipayConfig.sign_type.equals("MD5")) {
			mysign = MD5.sign(prestr, alipay_key, AlipayConfig.input_charset);
		}
	...
	private static Map<String, String> buildRequestPara(
			Map<String, String> sParaTemp, String alipay_key) {
		// 除去数组中的空值和签名参数
		Map<String, String> sPara = AlipayCore.paraFilter(sParaTemp);
		// 生成签名结果
		String mysign = buildRequestMysign(sPara, alipay_key);
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW,
			...
			String strButtonName, String alipay_key) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, alipay_key);
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW,
			Map<String, String> sParaTemp, String strMethod,
			String strButtonName, String strParaFileName, String alipay_key) {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, alipay_key);
		List<String> keys = new ArrayList<String>(sPara.keySet());
	...
	public static String buildRequest(String ALIPAY_GATEWAY_NEW,
			...
			Map<String, String> sParaTemp, String alipay_key) throws Exception {
		// 待请求参数数组
		Map<String, String> sPara = buildRequestPara(sParaTemp, alipay_key);
