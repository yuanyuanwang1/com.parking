 ...
 * 
 */
public class PayPostAction extends SuperAction {

	private String appId = null;

	private List<Map<String, Object>> lists = null;

	private Logger logger = Logger.getLogger(PayPostAction.class);
	...
	private String internetUrl=null;//域名地址
	
	private Map<String, Object> weixinInfo=null;
	
	private String returnUrl=null;//跳转地址
	...
	public void setWeixinInfo(Map<String, Object> weixinInfo) {
	...
	public String execute() {
		...
		if(map!=null)
		{
			 ...
			 if(mapPark!=null)
			 {
				 weixinInfo=parkingService.getWeixin(mapPark.get("pid").toString());
				 ...
				 if(weixinInfo!=null)
				 {
					  ...
					  internetUrl=weixinInfo.get("internet_url").toString();
				 }
			 }
		...
		lists = moneyPaymentService.getWxPayHelpers(pid, remoteAddr, openId,
				request, response);
		...
		System.out.println("internetUrl"+internetUrl);
		
		returnUrl="http://"+internetUrl;
