...
//
//		
//		CardAmount = formatAmtY2F(CardAmount);
//
//		String params = "parkCode=" + parkCode + "&CarNo=" + CarNo
//				+ "&CardType=" + CardType + "&CardIndate=" + CardIndate
//				+ "&CardAmount=" + CardAmount + "&CarType=" + CarType
//				+ "&MasterName=" + MasterName + "&MasterTel=" + MasterTel
//				+ "&MasterAddr=" + MasterAddr + "&ParkPosition=" + ParkPosition
//				+ "&PayAmount=" + PayAmount + "&Remark=" + Remark;
//		
...
//		}
	    ...
	    for (int i = 0; i < sourceStrArray.length; i++) {
	  	...
	  	String paramLevel = "parkCode=" + parkNos + "&CarNo=" + CarNo
	    				+ "&CardType=" + CardType + "&CardIndate=" + CardIndate
	    				+ "&CardAmount=" + CardAmount + "&CarType=" + CarType
	    				+ "&MasterName=" + MasterName + "&MasterTel=" + MasterTel
	    				+ "&MasterAddr=" + MasterAddr + "&ParkPosition=" + ParkPosition
		...
		map = parkingService.AddCar(paramLevel);
