package com.wy.sqlcteator.util;
...
public class StrUtil {
	...
	/**
	 * 字符串前后拼接给定字符，如：SO1506116511,SO1506117038
	 * 以字符"'"拼接结果：'SO1506116511','SO1506117038'
	 * 
	 * @param str
	 *            原字符串
	 * @param splitStr
	...
	public static String strAppend(String str, String splitStr, String appendStr) {
		...
		// List<String> strList = Splitter.on(splitStr).splitToList(
		// StringUtils.replaceChars(str, appendStr, ""));
		// List<String> newStrList = Lists.newArrayList();
		// for (String s : strList) {
		// if (isEmpty(s)) {
		// continue;
		// }
		// newStrList.add(appendStr + s + appendStr);
		// }
